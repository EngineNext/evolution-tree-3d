          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  info: {
                    era: '約5000万年前〜現在',
                    summary: '丸い体と鮮やかな斑紋を持つ甲虫。アブラムシを食べる益虫で、危険を感じると足の関節から苦い液を出す。',
                    facts: ['アブラムシを食べる益虫', '警告色で身を守る', '危険を感じると死んだふりをする'],
                  },
                },
                {
                  id: 'scorpion',
                  ...
                  info: {
                    era: '約4.3億年前〜現在',
                    summary: 'クモに近い節足動物。一対の鋏と毒針を持つ尾を備え、紫外線を当てると青白く光る古き狩人。',
                    facts: ['クモの仲間', '紫外線で光る', '陸に上がった最初期の動物の一つ'],
                  },
                },
              ],
            },
              ...
              children: [
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      info: {
                        era: '約1.5億年前〜現在',
                        summary: '平たい体を得たサメの近縁。胸びれを翼のように波打たせて海底を舞い、砂に潜んで身を隠す。',
                        facts: ['サメに近い軟骨魚', '胸びれで羽ばたくように泳ぐ', '電気で獲物を探す種もいる'],
                      },
                    },
                    {
                      id: 'clownfish',
                      ...
                      info: {
                        era: '約1200万年前〜現在',
                        summary: '毒を持つイソギンチャクの中で暮らす小魚。粘液で毒から身を守り、外敵から隠れて共に生きる。',
                        facts: ['イソギンチャクと共生する', '全て雄で生まれ雌に変わる', '毒に刺されない粘液を持つ'],
                      },
                    },
                  ],
                },
                      ...
                      children: [
                        {
                          ...
                          children: [
                            ...
                            },
                            {
                              ...
                              info: {
                                era: '約2億年前〜現在',
                                summary: '爬虫類の基本形をとどめる四足の狩人。危険が迫ると尾を自ら切り離して逃げ、後で再生させる。',
                                facts: ['尾を切って逃げる', '切れた尾は再生する', 'ヘビは彼らから進化した'],
                              },
                            },
                          ],
                        },
                        {
                          ...
                          children: [
                            ...
                            },
                            {
                              ...
                              info: {
                                era: '約8000年前〜現在（家禽化）',
                                summary: '東南アジアの野鶏を家畜化した鳥。地上で暮らし、恐竜の面影を最も色濃く残す身近な生き物とされる。',
                                facts: ['ティラノサウルスに近縁とされる', '世界で最も多い鳥', '祖先は東南アジアの野鶏'],
                              },
                            },
                            {
                              id: 'flamingo',
                              ...
                              info: {
                                era: '約3000万年前〜現在',
                                summary: '長い脚と首を持つ水鳥。逆さにした嘴で水をこして小さな餌を食べ、餌の色素で羽がピンクに染まる。',
                                facts: ['餌のせいで体がピンク色', '片脚で立って眠る', '嘴を逆さにして食べる'],
                              },
                            },
                          ],
                        },
                        {
                          ...
                          children: [
                            ...
                            },
                            {
                              ...
                              info: {
                                era: '約1万年前〜現在（家畜化）',
                                summary: '単独の狩人であるヤマネコを祖先に持つネコ科。しなやかな体と鋭い感覚を残したまま人と暮らすようになった。',
                                facts: ['暗闇でよく見える目を持つ', 'ヒゲで幅を測る', '一日の大半を眠って過ごす'],
                              },
                            },
                            {
                              id: 'dog',
                              ...
                              info: {
                                era: '約1.5万年前〜現在（家畜化）',
                                summary: 'オオカミから分かれ、人と最も古く結びついた動物。鋭い嗅覚と社会性を活かし、人の暮らしを支えてきた。',
                                facts: ['祖先はオオカミ', '嗅覚は人の数千〜1億倍', '人が最初に家畜化した動物'],
                              },
                            },
                            {
                              id: 'rabbit',
                              ...
                              info: {
                                era: '約4000万年前〜現在',
                                summary: '長い耳と強い後脚を持つ草食獣。広い視野で天敵を警戒し、跳ねて逃げる。耳は体温調節の役目も担う。',
                                facts: ['ほぼ360度を見渡せる', '長い耳で体温を逃がす', '自分のフンを食べ栄養を再吸収する'],
                              },
                            },
                            {
                              id: 'bear',
                              ...
                              info: {
                                era: '約500万年前〜現在',
                                summary: '大きな体と力を持つ食肉類。何でも食べる雑食で、冬には巣ごもりして眠り、春まで飲まず食わずで過ごす種もいる。',
                                facts: ['冬ごもりで長期間眠る', '雑食で何でも食べる', '嗅覚は犬より鋭いとされる'],
                              },
                            },
                            {
                              id: 'giraffe',
                              ...
                              info: {
                                era: '約1000万年前〜現在',
                                summary: '地上で最も背の高い動物。長い首で高い木の葉を食べるが、首の骨の数はヒトと同じ7個しかない。',
                                facts: ['首の骨はヒトと同じ7個', '舌は約50cmと長い', '高い血圧を保つ特別な心臓を持つ'],
                              },
                            },
                            {
                              id: 'deer',
                              ...
                              info: {
                                era: '約2000万年前〜現在',
                                summary: '枝分かれした角を持つ草食獣。角は毎年生え替わり、動物の中でも最も速く成長する骨として知られる。',
                                facts: ['角は毎年抜けて生え替わる', '角は最速で伸びる骨', 'クジラと同じ偶蹄類の仲間'],
                              },
                            },
                            {
                              id: 'dolphin',
                              ...
                              info: {
                                era: '約1000万年前〜現在',
                                summary: '海に暮らす高い知能の哺乳類。超音波で周囲を「見て」、仲間を名前のような音で呼び合うともいわれる。',
                                facts: ['超音波で獲物を探す', '脳が大きく知能が高い', '眠るとき脳を半分ずつ休める'],
                              },
                            },
                          ],
                        },
